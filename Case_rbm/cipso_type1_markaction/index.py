...
pkt1_files = [["0001_TCP_ETH_IPV4_TCP_1_16_13_0x1,0x2,0x3,0x4_P80.pcap", "test_cipso_type1_markaction_a1_01.pcap"]]
...
case1_tgLabel = {
    'TgLabel': {
        'DOI': 16,  # Doi
        'Type': type,  # 解释域，整形，取值1~UINT32_MAX
        'Sensitivity': clevel,  # 机密性级别，数值字符串，数值小于255
...
'''
用例二：验证含type1标记策略的是反向会话时的规则 
'''
pkt2_files = [["0001_TCP_ETH_IPV4_TCP_1_16_13_0x1,0x2,0x3,0x4_P80.pcap", "test_cipso_type1_markaction_a2_01.pcap"]]
value2 = r"b'\x00\x00\x00\x10\x01\x05\x00\r\x80'"
pkt2_cfg={
